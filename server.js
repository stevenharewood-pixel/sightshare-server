...
app.get('/', (req, res) => {
  ...
  if (fs.existsSync(adminPath)) {
    ...
    console.log('admin.html not found, serving inline version');
    res.send(`
<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>SightShare Admin</title>
<script src="https://cdn.tailwindcss.com"></script></head>
<body class="bg-gray-50 p-8">
<div class="max-w-4xl mx-auto">
<h1 class="text-3xl font-bold mb-4">SightShare Admin Dashboard</h1>
<p class="text-red-600 mb-4">⚠️ Admin dashboard file not found. Please create public/admin.html</p>
<div class="bg-white rounded shadow p-6">
<h2 class="text-xl font-bold mb-4">API Endpoints Available:</h2>
<ul class="space-y-2 text-sm">
<li>✅ GET /api/health - Health check</li>
<li>✅ GET /api/stats - Statistics</li>
<li>✅ GET /api/guests - All guests</li>
<li>✅ GET /api/orders - All orders</li>
<li>✅ POST /api/guests - Submit guest</li>
<li>✅ POST /api/orders - Submit order</li>
</ul>
<p class="mt-4"><a href="/api/stats" class="text-blue-600 hover:underline">View Stats →</a></p>
</div></div></body></html>
    `);
  }
});
